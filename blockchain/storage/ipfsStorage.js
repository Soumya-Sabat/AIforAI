// storage/ipfsStorage.js - FIXED VERSION
// Works without ipfs-http-client package issues
 ...
 * Fixed to work with native Node.js modules
 */
class IPFSStorage {
  constructor(config = {}) {
    this.config = {
  ...
  /**
   * Add file to IPFS using multipart form data
   */
